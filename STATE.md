...
**المرحلة الحالية:** 5 - ربط Supabase + 6 - تحسينات + 9 - إصلاحات + 10 - نظام التعليقات + 11 - التحسينات النهائية (Favicon + OG + 404 + JSON-LD + Dark Mode + إعدادات التحكم) — الكل مكتمل 100% ✅
...
- [x] إضافة دعم الوضع الليلي (Dark Mode) مع toggle في جميع الصفحات
